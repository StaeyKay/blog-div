                ...
                <div key={blog.id} className='p-4 bg-white shadow-md rounded-lg'>
                  <div className='flex justify-between items-center mb-4'>
                    ...
                    <div className='flex items-center space-x-4'>
                      <button className='cursor-pointer hover:scale-105'><Heart /></button>
                      <button className='cursor-pointer hover:scale-105' onClick={() => handleDelete(blog.id)}><Trash2 /></button>
                    </div>
                  </div>
